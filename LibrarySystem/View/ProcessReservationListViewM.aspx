...
<asp:Content ID="Content1" ContentPlaceHolderID="Master_Librarian_Content" runat="server">
    <div style="margin-left: 0;">
        ...
        <h3>Process Reservation List</h3>
        <br />
        ...
        <br />
        <asp:GridView ID="gvReservation" runat="server" OnRowEditing="gvReservation_RowEditing" OnRowDeleting="gvReservation_RowDeleting">
            <Columns>
                <asp:TemplateField HeaderText="Cancel">
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Delete" OnClientClick="return confirm('Your will cancel this reservation. Do you want to continue?')">Cancel</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
